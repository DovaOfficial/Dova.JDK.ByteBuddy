...
[JniSignatureAttribute("Lnet/bytebuddy/jar/asm/ModuleWriter;", "final")]
	...
	: Dova.JDK.net.bytebuddy.jar.asm.ModuleVisitor
{
	...
	static ModuleWriter()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lnet/bytebuddy/jar/asm/ModuleWriter;");
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "requires", "Lnet/bytebuddy/jar/asm/ByteVector;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "exportsCount", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "exports", "Lnet/bytebuddy/jar/asm/ByteVector;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "opensCount", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "opens", "Lnet/bytebuddy/jar/asm/ByteVector;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "usesCount", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "usesIndex", "Lnet/bytebuddy/jar/asm/ByteVector;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "providesCount", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "provides", "Lnet/bytebuddy/jar/asm/ByteVector;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "packageCount", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "packageIndex", "Lnet/bytebuddy/jar/asm/ByteVector;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "mainClassIndex", "I"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lnet/bytebuddy/jar/asm/SymbolTable;III)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "putAttributes", "(Lnet/bytebuddy/jar/asm/ByteVector;)V"));
	...
	public Dova.JDK.net.bytebuddy.jar.asm.ByteVector requires_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lnet/bytebuddy/jar/asm/ByteVector;", "private final")]
	public Dova.JDK.net.bytebuddy.jar.asm.ByteVector exports_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lnet/bytebuddy/jar/asm/ByteVector;", "private final")]
	public Dova.JDK.net.bytebuddy.jar.asm.ByteVector opens_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lnet/bytebuddy/jar/asm/ByteVector;", "private final")]
	public Dova.JDK.net.bytebuddy.jar.asm.ByteVector usesIndex_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lnet/bytebuddy/jar/asm/ByteVector;", "private final")]
	public Dova.JDK.net.bytebuddy.jar.asm.ByteVector provides_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lnet/bytebuddy/jar/asm/ByteVector;", "private final")]
	public Dova.JDK.net.bytebuddy.jar.asm.ByteVector packageIndex_Property
	{
		get
		{
	...
	[JniSignatureAttribute("(Lnet/bytebuddy/jar/asm/SymbolTable;III)V", "")]
	public ModuleWriter(Dova.JDK.net.bytebuddy.jar.asm.SymbolTable arg0, int arg1, int arg2, int arg3) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3))
	{
	}

	public override string GetJavaClassSignature() => "Lnet/bytebuddy/jar/asm/ModuleWriter;";
	...
	public void putAttributes(Dova.JDK.net.bytebuddy.jar.asm.ByteVector arg0)
	{
