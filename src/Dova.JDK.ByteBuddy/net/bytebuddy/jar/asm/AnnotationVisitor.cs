...
[JniSignatureAttribute("Lnet/bytebuddy/jar/asm/AnnotationVisitor;", "public abstract")]
	...
	: Dova.JDK.java.lang.Object
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lnet/bytebuddy/jar/asm/AnnotationVisitor;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "api", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "av", "Lnet/bytebuddy/jar/asm/AnnotationVisitor;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(I)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(ILnet/bytebuddy/jar/asm/AnnotationVisitor;)V"));
	...
	[JniSignatureAttribute("Lnet/bytebuddy/jar/asm/AnnotationVisitor;", "protected")]
	public Dova.JDK.net.bytebuddy.jar.asm.AnnotationVisitor av_Property
	{
		get
		{
	...
	[JniSignatureAttribute("(ILnet/bytebuddy/jar/asm/AnnotationVisitor;)V", "protected")]
	public AnnotationVisitor(int arg0, Dova.JDK.net.bytebuddy.jar.asm.AnnotationVisitor arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Lnet/bytebuddy/jar/asm/AnnotationVisitor;";
