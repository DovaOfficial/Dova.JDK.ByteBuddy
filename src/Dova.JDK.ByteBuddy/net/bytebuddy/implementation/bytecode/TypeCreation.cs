...
[JniSignatureAttribute("Lnet/bytebuddy/implementation/bytecode/TypeCreation;", "public")]
public partial class TypeCreation
	: Dova.JDK.net.bytebuddy.implementation.bytecode.StackManipulation.AbstractBase
{
	...
	static TypeCreation()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lnet/bytebuddy/implementation/bytecode/TypeCreation;");
	...
	public TypeCreation(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lnet/bytebuddy/description/type/TypeDescription;)V", "protected")]
	public TypeCreation(Dova.JDK.net.bytebuddy.description.type.TypeDescription arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lnet/bytebuddy/implementation/bytecode/TypeCreation;";
