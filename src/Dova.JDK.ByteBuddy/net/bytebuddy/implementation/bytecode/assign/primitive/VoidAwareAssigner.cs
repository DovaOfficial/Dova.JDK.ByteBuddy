...
[JniSignatureAttribute("Lnet/bytebuddy/implementation/bytecode/assign/primitive/VoidAwareAssigner;", "public")]
public partial class VoidAwareAssigner
	...
	, Dova.JDK.net.bytebuddy.implementation.bytecode.assign.Assigner
{
	...
	static VoidAwareAssigner()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lnet/bytebuddy/implementation/bytecode/assign/primitive/VoidAwareAssigner;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "chained", "Lnet/bytebuddy/implementation/bytecode/assign/Assigner;"));
	...
	public Dova.JDK.net.bytebuddy.implementation.bytecode.assign.Assigner chained_Property
	{
		get
		{
	...
	public VoidAwareAssigner(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lnet/bytebuddy/implementation/bytecode/assign/Assigner;)V", "public")]
	public VoidAwareAssigner(Dova.JDK.net.bytebuddy.implementation.bytecode.assign.Assigner arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lnet/bytebuddy/implementation/bytecode/assign/primitive/VoidAwareAssigner;";
