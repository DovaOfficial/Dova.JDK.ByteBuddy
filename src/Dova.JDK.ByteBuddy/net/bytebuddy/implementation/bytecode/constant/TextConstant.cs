...
[JniSignatureAttribute("Lnet/bytebuddy/implementation/bytecode/constant/TextConstant;", "public")]
public partial class TextConstant
	: Dova.JDK.net.bytebuddy.implementation.bytecode.StackManipulation.AbstractBase
{
	...
	static TextConstant()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lnet/bytebuddy/implementation/bytecode/constant/TextConstant;");
	...
	public TextConstant(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/String;)V", "public")]
	public TextConstant(Dova.JDK.java.lang.String arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lnet/bytebuddy/implementation/bytecode/constant/TextConstant;";
