...
[JniSignatureAttribute("Lnet/bytebuddy/matcher/DeclaringTypeMatcher;", "public")]
public partial class DeclaringTypeMatcher
	: Dova.JDK.net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues
{
	...
	static DeclaringTypeMatcher()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lnet/bytebuddy/matcher/DeclaringTypeMatcher;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "doMatch_0", "(Lnet/bytebuddy/description/DeclaredByType;)Z"));
	...
	public DeclaringTypeMatcher(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lnet/bytebuddy/matcher/ElementMatcher;)V", "public")]
	public DeclaringTypeMatcher(Dova.JDK.net.bytebuddy.matcher.ElementMatcher arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lnet/bytebuddy/matcher/DeclaringTypeMatcher;";
	...
	[JniSignatureAttribute("(Lnet/bytebuddy/description/DeclaredByType;)Z", "protected")]
