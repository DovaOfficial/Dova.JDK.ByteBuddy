...
[JniSignatureAttribute("Lnet/bytebuddy/matcher/DefinedShapeMatcher;", "public")]
public partial class DefinedShapeMatcher
	: Dova.JDK.net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues
{
	...
	static DefinedShapeMatcher()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lnet/bytebuddy/matcher/DefinedShapeMatcher;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "doMatch_0", "(Lnet/bytebuddy/description/ByteCodeElement$TypeDependant;)Z"));
	...
	public DefinedShapeMatcher(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lnet/bytebuddy/matcher/ElementMatcher;)V", "public")]
	public DefinedShapeMatcher(Dova.JDK.net.bytebuddy.matcher.ElementMatcher arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lnet/bytebuddy/matcher/DefinedShapeMatcher;";
	...
	[JniSignatureAttribute("(Lnet/bytebuddy/description/ByteCodeElement$TypeDependant;)Z", "protected")]
