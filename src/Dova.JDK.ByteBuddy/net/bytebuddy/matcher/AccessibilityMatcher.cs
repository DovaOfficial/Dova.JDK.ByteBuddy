...
[JniSignatureAttribute("Lnet/bytebuddy/matcher/AccessibilityMatcher;", "public")]
public partial class AccessibilityMatcher
	: Dova.JDK.net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues
{
	...
	static AccessibilityMatcher()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lnet/bytebuddy/matcher/AccessibilityMatcher;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "doMatch_0", "(Lnet/bytebuddy/description/ByteCodeElement;)Z"));
	...
	public AccessibilityMatcher(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lnet/bytebuddy/description/type/TypeDescription;)V", "public")]
	public AccessibilityMatcher(Dova.JDK.net.bytebuddy.description.type.TypeDescription arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lnet/bytebuddy/matcher/AccessibilityMatcher;";
	...
	[JniSignatureAttribute("(Lnet/bytebuddy/description/ByteCodeElement;)Z", "protected")]
