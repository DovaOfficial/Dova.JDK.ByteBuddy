...
[JniSignatureAttribute("Lnet/bytebuddy/matcher/MethodParameterTypeMatcher;", "public")]
public partial class MethodParameterTypeMatcher
	: Dova.JDK.net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues
{
	...
	static MethodParameterTypeMatcher()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lnet/bytebuddy/matcher/MethodParameterTypeMatcher;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "doMatch_0", "(Lnet/bytebuddy/description/method/ParameterDescription;)Z"));
	...
	public MethodParameterTypeMatcher(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lnet/bytebuddy/matcher/ElementMatcher;)V", "public")]
	public MethodParameterTypeMatcher(Dova.JDK.net.bytebuddy.matcher.ElementMatcher arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lnet/bytebuddy/matcher/MethodParameterTypeMatcher;";
	...
	[JniSignatureAttribute("(Lnet/bytebuddy/description/method/ParameterDescription;)Z", "protected")]
