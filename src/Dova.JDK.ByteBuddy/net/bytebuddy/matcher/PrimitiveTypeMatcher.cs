...
[JniSignatureAttribute("Lnet/bytebuddy/matcher/PrimitiveTypeMatcher;", "public")]
public partial class PrimitiveTypeMatcher
	: Dova.JDK.net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues
{
	...
	static PrimitiveTypeMatcher()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lnet/bytebuddy/matcher/PrimitiveTypeMatcher;");
	...
	public PrimitiveTypeMatcher(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public PrimitiveTypeMatcher() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lnet/bytebuddy/matcher/PrimitiveTypeMatcher;";
