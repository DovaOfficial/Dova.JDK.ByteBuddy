...
[JniSignatureAttribute("Lnet/bytebuddy/matcher/DescriptorMatcher;", "public")]
public partial class DescriptorMatcher
	: Dova.JDK.net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lnet/bytebuddy/matcher/DescriptorMatcher;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "doMatch_0", "(Lnet/bytebuddy/description/NamedElement$WithDescriptor;)Z"));
	...
	public DescriptorMatcher(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lnet/bytebuddy/matcher/ElementMatcher;)V", "public")]
	public DescriptorMatcher(Dova.JDK.net.bytebuddy.matcher.ElementMatcher arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lnet/bytebuddy/matcher/DescriptorMatcher;";
	...
	[JniSignatureAttribute("(Lnet/bytebuddy/description/NamedElement$WithDescriptor;)Z", "protected")]
