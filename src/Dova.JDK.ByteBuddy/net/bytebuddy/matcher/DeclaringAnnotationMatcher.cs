...
[JniSignatureAttribute("Lnet/bytebuddy/matcher/DeclaringAnnotationMatcher;", "public")]
public partial class DeclaringAnnotationMatcher
	: Dova.JDK.net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues
{
	...
	static DeclaringAnnotationMatcher()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lnet/bytebuddy/matcher/DeclaringAnnotationMatcher;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "doMatch_0", "(Lnet/bytebuddy/description/annotation/AnnotationSource;)Z"));
	...
	public DeclaringAnnotationMatcher(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lnet/bytebuddy/matcher/ElementMatcher;)V", "public")]
	public DeclaringAnnotationMatcher(Dova.JDK.net.bytebuddy.matcher.ElementMatcher arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lnet/bytebuddy/matcher/DeclaringAnnotationMatcher;";
	...
	[JniSignatureAttribute("(Lnet/bytebuddy/description/annotation/AnnotationSource;)Z", "protected")]
