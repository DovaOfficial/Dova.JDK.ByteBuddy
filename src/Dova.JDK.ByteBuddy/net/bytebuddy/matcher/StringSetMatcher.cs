...
[JniSignatureAttribute("Lnet/bytebuddy/matcher/StringSetMatcher;", "public")]
public partial class StringSetMatcher
	: Dova.JDK.net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lnet/bytebuddy/matcher/StringSetMatcher;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "values", "Ljava/util/Set;"));
	...
	public Dova.JDK.java.util.Set values_Property
	{
		get
		{
	...
	public StringSetMatcher(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/util/Set;)V", "public")]
	public StringSetMatcher(Dova.JDK.java.util.Set arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lnet/bytebuddy/matcher/StringSetMatcher;";
