...
[JniSignatureAttribute("Lnet/bytebuddy/matcher/MethodParameterTypesMatcher;", "public")]
public partial class MethodParameterTypesMatcher
	: Dova.JDK.net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues
{
	...
	static MethodParameterTypesMatcher()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lnet/bytebuddy/matcher/MethodParameterTypesMatcher;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "doMatch_0", "(Lnet/bytebuddy/description/method/ParameterList;)Z"));
	...
	public MethodParameterTypesMatcher(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lnet/bytebuddy/matcher/ElementMatcher;)V", "public")]
	public MethodParameterTypesMatcher(Dova.JDK.net.bytebuddy.matcher.ElementMatcher arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lnet/bytebuddy/matcher/MethodParameterTypesMatcher;";
	...
	[JniSignatureAttribute("(Lnet/bytebuddy/description/method/ParameterList;)Z", "protected")]
